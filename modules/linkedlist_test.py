...
class LinkedListTest(unittest.TestCase):
    ...
    # My unit tests!
    def test_length_after_initialization(self):
        ll = LinkedList(['A', 'N', 'D', 'R', 'E', 'Y'])
        assert ll.length() == 6
    ...
    def test_prepend_after_initialization(self):
        ll = LinkedList(['A', 'N', 'D', 'R', 'E', 'Y'])
        assert ll.length() == 6
    ...
    def test_find_after_initialization(self):
        ll = LinkedList(['A', 'N', 'D', 'R', 'E', 'Y'])

        assert ll.find(lambda x: x == 'A') == 'A'
        assert ll.find(lambda x: x == 'S') is None
        assert ll.find(lambda x: x < 'B') == 'A'

    def test_delete_after_initialization(self):
        ll = LinkedList(['H', 'I'])
    ...
    def test_replace_after_initialization(self):
        ll = LinkedList(['H', 'I'])

        assert ll.find(lambda x: x == 'H') == 'H'

        ll.replace('H', "K")
        assert ll.find(lambda x: x == 'H') is None
        assert ll.find(lambda x: x == 'K') == 'K'
